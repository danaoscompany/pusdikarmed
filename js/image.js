		...
		success: function(response) {
			...
			for (var i=0; i<images.length; i++) {
				...
				$("#images").append("<div class=\"col-md-6 col-lg-3\">\n" +
					...
					"             <img src=\"http://pusdikarmed.kodiklat-tniad.mil.id/pusdikarmed/userdata/"+image['path']+"\" style='border-radius: 5px;' width=\"100%\" height=\"150px\">\n" +
...
function viewImage(index) {
	...
	$("#uuid").val(image['uuid']);
	$.redirect("http://pusdikarmed.kodiklat-tniad.mil.id/pusdikarmed/image/view_image", {
		uuid: image['uuid']
	});
}
